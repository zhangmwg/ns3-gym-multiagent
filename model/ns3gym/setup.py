...
if not os.path.isfile(protobufFile):
    print("File: ", "src/opengym/model/ns3gym/ns3gym/messages_pb2.py", " was not found.")
...
setup(
    ...
    url='',
    license='MIT',
    author='Piotr Gawlowicz, Zhangmin Wang',
    author_email='gawlowicz.p@gmail.com, zhangmwg@gmail.com',
